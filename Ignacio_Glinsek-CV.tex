...
\cventry{04/2019 -- Present}{Principal Software Engineer}{SecureAuth}{}{}{Lead and mentor developers as well as drive the architecture of the
  \httplink[SecureAuth Identity Platform]{https://www.secureauth.com/identity-access-management/}. My achievements include:
  \begin{itemize}
    ...
    \item Own a migration from Windows VM to Kubernetes Windows Nodes using Terraform and EKS.
    \item Promote development standard methodologies in a continually-shipping environment.
  \end{itemize}}
\cventry{10/2017 -- 04/2019}{Lead Application Engineer}{Rise Interactive}{}{}{Maintain and develop new features for the
...
\cventry{03/2017 -- 10/2017}{Full Stack Senior Developer}{SouthWorks}{}{}{Worked as a Microsoft vendor in different Azure projects:
  \begin{itemize}
    \item Maintain Azure Media Services portal
